...
# generates an integer between 6 and 0
...
while user_points < 13 and computer_points < 13:
    ...
    if user_points > 13:
        print(f"Woops! You rolled a {user_move} so your total is {user_points}."
              f"Which is over 13 points so you lose this round and"
              f" don't get any points added to your total score😨😔😢💔👎😭 boohoo😭.")
